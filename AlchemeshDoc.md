...
Mesh Name: in this text input, type the name you want the meshes resulting from the combination to have. By default CombinedMesh.
...
The solution would be to modify the parameters to find the best result.
